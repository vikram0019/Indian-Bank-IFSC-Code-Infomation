...
add_shortcode('ifsc_search_tabs', function () {
    ...
    <div class="ifsc-search-tabs" id="ifsc-search-tabs">
        <div class="ifsc-tabs-nav">
            <button type="button" class="ifsc-tab-btn is-active" data-tab="ifsc">By IFSC Code</button>
            <button type="button" class="ifsc-tab-btn" data-tab="bank">By Bank + City</button>
            <button type="button" class="ifsc-tab-btn" data-tab="branch">By Branch Name</button>
        </div>

        <form class="ifsc-tab-panel is-active ifsc-form-row" data-panel="ifsc" id="ifsc-form-ifsc">
        ...
        <form class="ifsc-tab-panel ifsc-form-row" data-panel="bank" id="ifsc-form-bank" hidden>
